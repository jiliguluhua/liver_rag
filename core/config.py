...
KNOWLEDGE_SERVICE_URL = os.getenv("LIVER_KNOWLEDGE_SERVICE_URL", "http://127.0.0.1:8081").strip()
...
REDIS_SESSION_CONTEXT_TTL_SECONDS = int(os.getenv("LIVER_REDIS_SESSION_CONTEXT_TTL_SECONDS", "43200"))
SESSION_CONTEXT_MAX_TURNS = int(os.getenv("LIVER_SESSION_CONTEXT_MAX_TURNS", "3"))
